...
> In this project, We  interpret a database diagram and implement the SQL needed to build that database.
...
Clone this repository to your desired folder:
  ...
  mkdir vet-database
  cd vet-database
  git clone git@github.com:eamador1/clinic-database.git
...
Feel free to check the [issues page](https://github.com/eamador1/clinic-database/issues).
